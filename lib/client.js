window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		function TabsIsland({ services, rows, archived, workspacePaths, wide }) {
			...
			react.createElement("rect", { x: 2, y: 9.2, width: 12, height: 4.8, rx: 1.4 }),
			// 对称指示灯：左上=工作区、左下=Channels，只亮当前 tab 那盏
			react.createElement("circle", {
				cx: 4.8, cy: 4.2, r: 1.1, fill: "currentColor", stroke: "none",
				opacity: view === "workspace" ? 1 : 0,
			}),
			react.createElement("circle", {
				cx: 4.8, cy: 11.6, r: 1.1, fill: "currentColor", stroke: "none",
				opacity: view === "channels" ? 1 : 0,
			}))) : null;
